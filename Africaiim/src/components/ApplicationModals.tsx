            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-light" style={{ color: '#1a5443' }}>
                      {t('dashboard.reviewApplication')}
                    </h2>
                    <p className="text-sm text-gray-500 font-light">{t('dashboard.reviewSubtitle')}</p>
                  </div>
                </div>
                <button
                  onClick={onCloseReview}
              ...
              <div className="p-6 space-y-6">
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="relative">
                      <img
                        ...
                        alt={t('dashboard.passportSizePhoto')}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.name')}</p>
                      <p className="font-normal">{formData.firstName} {formData.lastName}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.dateOfBirth')}</p>
                      <p className="font-normal">{formData.dateOfBirth}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.nationality')}</p>
                      <p className="font-normal">{formData.nationality}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.cityCountry')}</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.emailAddress')}</p>
                      <p className="font-normal">{formData.email}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.phoneNumber')}</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.highSchoolName')}</p>
                      <p className="font-normal">{formData.highSchoolName}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.graduationYear')}</p>
                      <p className="font-normal">{formData.graduationYear}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.gpaGrade')}</p>
                      <p className="font-normal">{formData.gpa}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.highSchoolCountry')}</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-sm">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.program')}</p>
                      <p className="font-normal">{formData.programChoice}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.intakeYear')}</p>
                      <p className="font-normal">{formData.intakeYear}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.intakeSemester')}</p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.englishProficiency')}</p>
                    ...
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light">{t('dashboard.frenchProficiency')}</p>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light text-sm mb-2">{t('dashboard.whyAFRICAIIMShort')}</p>
                      <p className="text-sm">{formData.whyAFRICAIIM}</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <p className="text-gray-500 font-light text-sm mb-2">{t('dashboard.careerGoalsShort')}</p>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {Object.values(uploadedDocuments).every(file => !file) && (
                      <p className="text-gray-500 text-sm font-light p-3">{t('dashboard.noDocumentsUploaded')}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="sticky bottom-0 bg-white border-t border-gray-200 p-6 flex gap-3">
                ...
                >
                  {t('dashboard.confirmSubmitApplication')}
                </motion.button>
              </div>
            </motion.div>
          </>
          ...
          <>
            ...
            >
              ...
              <div className="p-4 rounded-lg mb-6" style={{ backgroundColor: '#f0f9f6' }}>
                <p className="text-sm font-light text-gray-700 mb-2">{t('dashboard.applicationId')}</p>
