  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className="text-lg uppercase tracking-wider mb-4 font-bold"
            style={{ color: '#b8873e' }}
          >
            {t('contact.label')}
          </div>
          <h2 className="text-5xl md:text-6xl mb-6 font-light" style={{ color: '#1a5443' }}>
            {t('contact.title')}
          </h2>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <label htmlFor="firstName" className="block text-base mb-2 font-medium text-gray-700">
                  {t('contact.firstName')} *
                </label>
                <input
                  type="text"
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.3 }}
              >
                <label htmlFor="lastName" className="block text-base mb-2 font-medium text-gray-700">
                  {t('contact.lastName')} *
                </label>
                <input
                  type="text"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.4 }}
              >
                <label htmlFor="phone" className="block text-base mb-2 font-medium text-gray-700">
                  {t('contact.phone')} *
                </label>
                <input
                  type="tel"
            ...
            >
              <label htmlFor="subject" className="block text-base mb-2 font-medium text-gray-700">
                {t('contact.subject')} *
              </label>
              <select
                id="subject"
              ...
              >
                ...
                <option value="admissions">{t('contact.admissionsInquiry')}</option>
                <option value="programs">{t('contact.programInfo')}</option>
                <option value="campus">{t('contact.campusVisit')}</option>
                <option value="partnerships">{t('contact.partnerships')}</option>
            ...
            >
              <label htmlFor="message" className="block text-base mb-2 font-medium text-gray-700">
                {t('contact.message')} *
              </label>
              <textarea
                id="message"
            ...
            >
              ...
              <p className="text-base text-gray-500 mt-5 font-light">
                {t('contact.required')}
              </p>
            </motion.div>
          </form>
