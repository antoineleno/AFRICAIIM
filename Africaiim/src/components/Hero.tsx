...
import campusImage from '../assets/campus_1.jpg';
...
export function Hero({ onNavigateToAuth }: HeroProps) {
  ...
  const images = [
    {
      url: campusImage,
      alt: 'AFRICAIIM Campus'
    },
    {
      url: studentsImage,
      alt: 'AFRICAIIM Students'
    },
    {
        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-4 rounded text-lg font-normal text-white transition-all duration-300 shadow-lg cursor-pointer whitespace-nowrap"
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-4 rounded text-lg font-normal border-2 border-white text-white transition-all duration-300 backdrop-blur-sm whitespace-nowrap"
