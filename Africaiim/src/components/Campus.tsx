...
export function Campus({ onNavigateToAuth }: CampusProps) {
  ...
  const features = [
    {
      icon: BookOpen,
      title: t('campus.modernLibrary'),
      description: t('campus.modernLibraryDesc'),
    ...
    {
      icon: Users,
      title: t('campus.collaborative'),
      description: t('campus.collaborativeDesc'),
    ...
    {
      icon: Building,
      title: t('campus.smartClassrooms'),
      description: t('campus.smartClassroomsDesc'),
    ...
    {
      icon: Award,
      title: t('campus.careerCenter'),
      description: t('campus.careerCenterDesc'),
