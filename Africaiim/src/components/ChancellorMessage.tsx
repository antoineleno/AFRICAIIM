          ...
          >
            ...
            >
              <p className="text-xl md:text-2xl text-gray-800 font-light leading-relaxed italic">
                "{t('chancellor.openingQuote')}"
              </p>

              <p className="text-lg text-gray-700 font-light leading-relaxed">
                {t('chancellor.paragraph1')}
              </p>

              <p className="text-lg text-gray-700 font-light leading-relaxed">
                {t('chancellor.paragraph2')}
              </p>

              <p className="text-lg text-gray-700 font-light leading-relaxed">
                {t('chancellor.paragraph3')}
              </p>
            ...
            >
              <h3 className="text-2xl font-light mb-2" style={{ color: '#1a5443' }}>
                {t('chancellor.signature')}
              </h3>
              <p className="text-lg font-light" style={{ color: '#b8873e' }}>
                {t('chancellor.signatureTitle')}
              </p>
              <p className="text-base text-gray-600 font-light mt-1">
                {t('chancellor.institutionName')}
              </p>
            </motion.div>
          </motion.div>
        </div>
