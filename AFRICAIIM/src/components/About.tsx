...
export function About() {
  ...
  const slides = [
    {
      title: "A Visionary Institution",
      subtitle: "Pioneering Excellence in West Africa",
      content: "The African Institute for Management and Innovation is a pioneering institution in West Africa, designed to address the challenges of globalization. Our bilingual program prepares students to thrive in a globalized world and gain admission to prestigious Master's programs worldwide.",
      accent: '#1a5443'
    },
    {
      title: "Bilingual Education",
      subtitle: "French & English Excellence",
      content: "Our innovative 3-year progressive program transforms students from French-language learners to fully bilingual graduates ready for international Master's programs. With intensive IELTS and GRE preparation, we ensure success at top universities.",
      accent: '#d4a574'
    },
    {
      title: "Global Partnerships",
      subtitle: "Connected to the World's Best",
      content: "We partner with prestigious universities including Boston University, emlyon Business School, and Sorbonne Business School. Our graduates gain direct pathways to these world-renowned institutions.",
      accent: '#1a5443'
    }
  ];

  const partnerUniversities = [
    { name: 'Boston University', school: 'Questrom School', img: bostonLogo },
    { name: 'emlyon', school: 'Business School', img: emlyonLogo },
    { name: 'Sorbonne Business School', school: 'Business School', img: sorbonneLogo },
  ];
